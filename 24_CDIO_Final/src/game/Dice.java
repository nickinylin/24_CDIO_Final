...
public class Dice {
    ...
    private static final int[] testDice1 = new int[]{0,0,0,1,1,4,1,5,1,5,3,1,1,3,6,6,6,2};
    private static final int[] testDice2 = new int[]{0,0,0,1,1,4,2,3,1,5,4,1,2,2,6,3,6,2};
