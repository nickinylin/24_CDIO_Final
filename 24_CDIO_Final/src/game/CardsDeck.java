...
public CardsDeck(){
	deck = new Cards[]{
			...
			new CardsTransaction("aktier", "Modtag udbytte af Deres aktier, modtag 1000kr", 1000),
			new CardsTransaction("aktier", "Modtag udbytte af Deres aktier, modtag 1000kr.", 1000),
			new CardsTransaction("Klasselotteri", "De har vundet i Klasselotteriet, modtag 500kr.", 500),
			new CardsTransaction("Klasselotteri", "De har vundet i Klasselotteriet, modtag 500kr.", 500),
			new CardsTransaction("Præmieobligation.", "Deres præmieobligation er udtrukket. De modtager 1000kr.", 1000),
			new CardsTransaction("Præmieobligation.", "Deres præmieobligation er udtrukket. De modtager 1000kr.", 1000),
			new CardsTransaction("Avl.", "Værdien af egen avl fra nyttehaven udgør 200kr, som De modtager af banken.", 200),
			new CardsTransaction("Kvartal skat.", "Kommunen har eftergivet et kvartals skat. Hæv i banken 3000kr.", 3000),
			new CardsTransaction("Tipning.", "De havde en række med elleve rigtige i tipning. Modtag 1000kr.", 1000),
			new CardsTransaction("Dyrtiden.", "Grundet dyrtiden har de fået gageforhøjelse. Modtag 1000kr.", 1000),
			new CardsTransaction("Møbler.", "De har solgt nogle gamle møbler på auktion, og modtager 1000kr.", 1000),
			new CardsTransaction("Aktieudbytte.", "De modtager deres aktieudbytte. Modtag 1000kr af banken", 1000),
			
			new CardsTransaction("Bilforsikring.", "Betal deres bilforsikring.", -1000),
			new CardsTransaction("Told.", "De har været en tur i udlandet og har haft for mange cigaretter med hjem. Betal told 200kr.", -200),
			new CardsTransaction("Parkeringsbæde.", "De har fået en parkeringsbøde. Betal 200kr.", -200),
			new CardsTransaction("Øl levering.", "Betal 200kr for levering af 2 kasser øl.", -200),
			new CardsTransaction("Fuldt stop.", "De har kørt frem for fuldt stop, betal 1000kr i bøde.", -1000),
			new CardsTransaction("Tandlægeregning.", "De har modtaget Deres tandlægeregning, betal 2000kr.", -2000),
			new CardsTransaction("Dæk.", "De har købt 4 nye dæk til Deres vogn, betal 1000kr.", -1000),
			new CardsTransaction("Reparation.", "Betal 3000kr for reparation af Deres vogn.", -3000),
			new CardsTransaction("Reparation.", "Betal 3000kr for reparation af Deres vogn.", -3000),
			new CardsTransaction("Vognvask & smøring.", "Betal 300kr for vognvask og smøring.", -300),
			new CardsTransaction("Ejendomsskat.", "Ejendomsskatterne er steget. Ekstraudgifterne er: 800kr pr. hus. 2300kr pr. hotel.", -800, 2300),
			new CardsTransaction("Oliepris.", "Oliepriserne er steget og De skal betale: 500kr pr. hus. 2000kr pr. hotel.", -500, 2000),,
...
//			new GetOutofJail(),
			...
			new CardsMoveto("Gå i fængsel. Ryk direkte til fængslet. Selv om De passerer START, indkasserer De ikke kr. 4000", Jail);
			new CardsMoveto("Gå i fængsel. Ryk direkte til fængslet. Selv om De passerer START, indkasserer De ikke kr. 4000", Jail);
